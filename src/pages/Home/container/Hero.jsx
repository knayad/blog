  ...
  return (
    <section className="container mx-auto flex flex-col px-5 py-5 lg:flex-row">
      <div className="mt-10 lg:w-1/2">
        <h1 className="font-sansita-san-serif text-3x text-center font-bold italic text-primary md:text-5xl lg:text-left lg:max-w--[540px]">
          Read and write reviews
        </h1>
        <p className="mt-4 text-center md:text-xl lg:text-left">
        ...
        <div className="flex mt-4 flex-col lg:flex-row lg:items-start lg:flex-nowrap lg:gap-x-4 lg:mt-7">
          <span className="text-[#959EAD] font-semibold italic mt-2 lg:mt-4">
            {" "}
            Popular tags:{" "}
          </span>
          <ul className="flex flex-wrap gap-x-2.5 gap-yp2.5 mt-3">
